...
1. Подключитесь к AP `TH-Sens-Setup` (пароль **`password`** — одинаковый на всех платах).
2. В браузере откройте **http://192.168.4.1/** (на телефоне часто нужно вручную; отключите LTE).
   Укажите SSID/пароль своей сети.
